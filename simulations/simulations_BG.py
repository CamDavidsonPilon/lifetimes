...
def generate_BG_neg_likelihoods(alpha, beta, penalizer_coef=0.1, T=None, size=100, simulation_size=100):
...
def goodness_of_test_BG(data, penalizer_coef=0.1, simulation_size=100, confidence_level=0.99):
    """
